  ...
  <q-page padding>
    ...
    <div class="row justify-end">
      <q-btn
        ...
        class="q-pa-sm"
        size="sm"
        label="Nouvelle condition de règlement"
        @click="
          dialogAction = 'create';
          createDialog = true;
        "
...
<script>
import CreatePaymentCondition from 'components/CreatePaymentCondition'
import io from 'socket.io-client'

export default {
  name: 'PaymentConditionPage',
  data () {
    return {
      socket: io(this.$axios.defaults.baseURL.replace('api/', '')),
      moduleName: 'paymentcondition',
      moduleLabel: 'La condition de règlement',
      dialogAction: 'create',
      rowData: '',
      createDialog: false,
